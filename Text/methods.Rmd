...
The \eqref{nieto} model is not a proportional risk rate model because there are different cure times indexed by $z_i$. This characteristic allows estimating the cure time for each individual by assigning a previous function $f(z_i)$ dependent on the covariates.
